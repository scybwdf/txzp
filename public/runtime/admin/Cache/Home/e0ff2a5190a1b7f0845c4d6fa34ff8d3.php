...
<div class="ibox float-e-margins">
            <div class="ibox-title">
                ...
                <div class="ibox-tools">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="<?php echo U('add');?>">新增管理员</a>
                        </li>
                        <li><a href="<?php echo U('Group/add');?>">新增管理组</a>
                        </li>
                    </ul>
                    <a class="close-link">
        ...
        <!-- Example Events -->
            ...
            <div class="example">
                ...
                <table id="tablelist" data-url="<?php echo U('adminlist');?>" data-mobile-responsive="true" >
                <thead>
                	<tr>
                		...
                		<th data-field="uid" data-sortable="true">所属管理组</th>
                		<th data-field="login_time" data-sortable="true">登陆时间</th>
                		<th data-field="login_ip" data-sortable="true">登陆IP</th>

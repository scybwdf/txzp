...
<div class="ibox float-e-margins">
    <div class="ibox-title">
        <h5 class="text-primary text-center">新增导航菜单</h5>
            ...
            <div class="col-xs-12">
                <form  class="form-horizontal" method="post" action="<?php echo U('add');?>">
                    	...
                    	<label class="control-label  col-sm-3">网址：</label>
                    	 <div class= "col-sm-2">
                              <select name="u_module" class="form-control" >
                                  ...
                                  <?php if(is_array($navs)): foreach($navs as $key=>$nav): ?><option value="<?php echo ($key); ?>" <?php if($key == $v['u_module']): ?>selected="selected"<?php endif; ?> ><?php echo ($nav["name"]); ?></option ><?php endforeach; endif; ?>
                              </select>
                         </div>
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-1">
                           是&nbsp;&nbsp;<input class="i-checks" type="radio" name="blank" checked="checked" value="1">
                        </div>
                         <div class="col-sm-1">
                           否&nbsp;&nbsp;<input class="i-checks" type="radio" name="blank" value="0">
                        </div>
                    </div>
          	        <div class="form-group col-sm-12">

...
<div class="ibox float-e-margins">
            <div class="ibox-title">
                <button disabled class="btn btn-default">文章分类列表</button>
                <a href="<?php echo U('add');?>" class="btn btn-primary">新增文章分类</a>
                <div class="ibox-tools">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="<?php echo U('add');?>">新增分类</a>
                        </li>
                        <li><a href="<?php echo U('Article/add');?>">新增文章</a>
                        </li>
                    </ul>
                    <a class="close-link">
            ...
            <div class="example">
                ...
                <thead>
                	<tr>
                		...
                		<th data-field="pid" data-sortable="true">所属分类</th>

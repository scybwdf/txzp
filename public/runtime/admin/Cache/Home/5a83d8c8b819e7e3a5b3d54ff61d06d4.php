...
<div class="ibox float-e-margins">
    <div class="ibox-title">
        <h5 class="text-primary text-center">新增视频</h5>
        <div class="ibox-tools">
            ...
            <ul class="dropdown-menu dropdown-user">
                <li><a href="<?php echo U('index');?>">视频列表</a>
                </li>
            </ul>
            <a class="close-link">
            ...
            <div class="col-xs-12">
                <form  class="form-horizontal" method="post" action="<?php echo U('add');?>">
                    <div class="form-group col-sm-12">
                       ...
                       <div class="form-group col-sm-12">
                        <label class="control-label col-sm-3">视频图片：</label>
                        <div class="col-sm-6">
                             <span>
        <div style='float:left; height:35px; padding-top:1px;'>
            <input type='hidden' value='' name='img' id='keimg_h_img' />
         ...
         <a href='/public/images/nophoto.gif' target='_blank' id='keimg_a_img' ><img src='/public/images/nophoto.gif' id='keimg_m_img' width=35 height=35 style='float:left; border:#ccc solid 1px; margin-left:5px;' /></a>
         <div style='float:left; height:35px; padding-top:1px;'>
             <div class='buttonActive'>
                <div class='buttonContent'>
                    <img src='/public/images/del.gif' style='display:none; margin-left:10px; float:left; border:#ccc solid 1px; width:35px; height:35px; cursor:pointer;' class='keimg_d' rel='img' title='删除'>
                </div>
            </div>
        </div>
        </span>
                       ...
                       <div class="form-group col-sm-12">
                        <label class="control-label col-sm-3">视频简介：</label>
                         <div class="col-sm-6">
                     ...
                     <div class="form-group col-sm-12">
                        <label class="control-label col-sm-3">视频ID：</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="video_id" required="" placeholder="">
                        </div>
                    </div>
                     <div class="form-group col-sm-12">
                        <label class="control-label col-sm-3">视频unique：</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="video_unique" required="" placeholder="">
                        </div>
                    </div>
                    <div class="form-group col-sm-12">
                        <label class="control-label col-sm-3">是否首页：</label>
                        <div class="col-sm-1">
                           是&nbsp;&nbsp;<input class="i-checks" type="radio" name="is_index" value="1">
                        </div>
                         <div class="col-sm-1">
                           否&nbsp;&nbsp;<input class="i-checks" type="radio" name="is_index" checked="checked"  value="0">
                        </div>
                    </div>
                      <div class="form-group col-sm-12">
                        <label class="control-label col-sm-3">是否热门：</label>
                        <div class="col-sm-1">

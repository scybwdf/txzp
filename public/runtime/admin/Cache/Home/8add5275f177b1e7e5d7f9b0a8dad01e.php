    ...
    <div class="ibox-title">
        ...
        <div class="ibox-tools">
            ...
            <ul class="dropdown-menu dropdown-user">
                <li><a href="<?php echo U('add');?>">新增管理组</a>
                </li>
                <li><a href="<?php echo U('Admin/add');?>">新增管理员</a>
                </li>
            </ul>
            <a class="close-link">
                ...
                <div class="example-wrap">
                    ...
                    <div class="example">
                        <div class="btn-group hidden-xs" id="tableToolbar" role="group">
                            ...
                            <button type="button" class="btn btn-outline btn-default redelete">
                        ...
                        <table id="tablelist" data-url="<?php echo U('index');?>" data-mobile-responsive="true" >
                            ...
                            <tr>
                                ...
                                <th data-field="name" data-sortable="true">规则</th>

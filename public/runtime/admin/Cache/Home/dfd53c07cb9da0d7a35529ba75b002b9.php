...
<div class="ibox float-e-margins">
            <div class="ibox-title">
                <button disabled class="btn btn-default">文章列表</button>
                <a href="<?php echo U('add');?>" class="btn btn-primary">新增文章</a>
        ...
        <!-- Example Events -->
            ...
            <div class="example">
                ...
                <table id="tablelist" data-url="<?php echo U('index');?>" data-mobile-responsive="true" >
                <thead>
                	<tr>

...
<div class="ibox float-e-margins">
    <div class="ibox-title">
        <button disabled class="btn btn-default">编辑文章</button>
    ...
    <div class="ibox-content">
                ...
                <form  class="form-horizontal" method="post" action="<?php echo U('edit');?>">
                    <div class="form-group col-sm-12">
              		 ...
              		 <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" name="writer" value="<?php echo ($vo["writer"]); ?>" required="" placeholder="">
                        </div>
                    </div>
                     <div class="form-group col-sm-12">
        ...
        <div style='float:left; height:35px; padding-top:1px;'>
         ...
         <a href='<?php if($vo["icon"] == ''): ?>/public/images/nophoto.gif<?php else: echo ($vo["icon"]); endif; ?>' target='_blank' id='keimg_a_icon' ><img src='<?php if($vo["icon"] == ''): ?>/public/images/nophoto.gif<?php else: echo ($vo["icon"]); endif; ?>' id='keimg_m_icon' width=35 height=35 style='float:left; border:#ccc solid 1px; margin-left:5px;' /></a>
         <div style='float:left; height:35px; padding-top:1px;'>
             <div class='buttonActive'>
                <div class='buttonContent'>
                    <img src='/public/images/del.gif' style='<?php if($vo["icon"] == ''): ?>display:none<?php endif; ?>; margin-left:10px; float:left; border:#ccc solid 1px; width:35px; height:35px; cursor:pointer;' class='keimg_d' rel='icon' title='删除'>
                </div>
            </div>
        </div>
        </span>
                    ...
                    <div class="form-group col-sm-12">
                        <label class="control-label col-sm-3">简介：</label>
                         <div class="col-sm-6">
                       		 <textarea name="brief" rows="5" class="form-control"><?php echo ($vo["brief"]); ?></textarea>
						</div>
                    </div>
                    	...
                    	<label class="control-label  col-sm-3">所属分类：</label>
                    	 <div class= "col-sm-6">
                             <select name="cate_id" class="form-control chosen-select" >
                                   <option value="0"  <?php if($vo['cate_id'] == 0): ?>selected="selected"<?php endif; ?>>==顶级分类==</option>
                					<?php if(is_array($cate)): foreach($cate as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if($vo['cate_id'] == $v['id']): ?>selected="selected"<?php endif; ?>><?php echo ($v["title_show"]); ?></option><?php endforeach; endif; ?>
                              </select>
                         </div>
                    </div>
                     <div class="form-group col-sm-12">
            		  ...
            		  <div class="col-sm-6">
          	 				<div  style='margin-bottom:5px; '><textarea id='editor' name='content' class='ketext' style='width:100%;height:100%' ><?php echo ($vo["content"]); ?></textarea> </div>
					  </div>	
        			</div>
                   	 <div class="form-group col-sm-12">
                        <label class="control-label col-sm-3">标签：</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" name="tags" value="<?php echo ($vo["tags"]); ?>" required="" placeholder="">
                        </div>
                    </div>
                       <div class="form-group col-sm-12">
                        <label class="control-label col-sm-3">热门：</label>
                        <div class="col-sm-1">
                           有效&nbsp;&nbsp;<input class="i-checks" type="radio" <?php if($vo['is_hot'] == 1): ?>checked="checked"<?php endif; ?>  name="is_hot" value="1">
                        </div>
                         <div class="col-sm-1">
                           无效&nbsp;&nbsp;<input class="i-checks" type="radio" name="is_hot" <?php if($vo['is_hot'] == 0): ?>checked="checked"<?php endif; ?>  value="0">
                        </div>
                    </div>
                    <div class="form-group col-sm-12">
                        <label class="control-label col-sm-3">本周必读：</label>
                        <div class="col-sm-1">
                           有效&nbsp;&nbsp;<input class="i-checks" type="radio" <?php if($vo['is_week'] == 1): ?>checked="checked"<?php endif; ?>  name="is_week" value="1">
                        </div>
                         <div class="col-sm-1">
                           无效&nbsp;&nbsp;<input class="i-checks" type="radio" name="is_week" <?php if($vo['is_week'] == 0): ?>checked="checked"<?php endif; ?>   value="0">
                        </div>
                    </div>
                    <div class="form-group col-sm-12">

...
<div class="ibox float-e-margins">
    <div class="ibox-title">
        <h5 class="text-primary text-center">新增管理员</h5>
        <div class="ibox-tools">
            ...
            <ul class="dropdown-menu dropdown-user">
                <li><a href="<?php echo U('index');?>">管理员列表</a>
                </li>
                <li>
                    <a href="#"></a>
                </li>
    ...
    <div class="ibox-content">
        <div class="row row-lg">
            <div class="col-xs-12">
                <form name="addadmin" class="form-horizontal" method="post">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-6">
                            <input type="password" class="form-control" name="password"  minlength="3" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group col-sm-12">

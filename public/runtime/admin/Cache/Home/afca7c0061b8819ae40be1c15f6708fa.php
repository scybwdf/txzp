...
<div class="ibox float-e-margins">
            <div class="ibox-title">
                ...
                <div class="ibox-tools">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="<?php echo U('add');?>">新增视频</a>
                        </li>
                    </ul>
                    <a class="close-link">
        ...
        <!-- Example Events -->
            ...
            <div class="example">
                ...
                <table id="tablelist" data-url="<?php echo U('videolist');?>" data-mobile-responsive="true" >
                <thead>
                	<tr>
                		<th data-checkbox="true"></th>
                		<th data-field="id" data-sortable="true">ID</th>
                		<th data-field="name" data-sortable="true">名称</th>
                		<th data-field="is_index" data-sortable="true" data-formatter="$.setindex">首页</th>

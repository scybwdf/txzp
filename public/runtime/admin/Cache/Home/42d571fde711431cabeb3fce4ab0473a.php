...
<div class="ibox float-e-margins">
    <div class="ibox-title">
        <button disabled class="btn btn-default">文章回收站列表</button>
        <div class="ibox-tools">
            ...
            <!--    <li><a href="<?php echo U('add');?>">新增文章</a>
                </li>
                <li><a href="<?php echo U('ArticleCate/add');?>">新增分类</a>
                </li>-->
            </ul>
            <a class="close-link">
                ...
                <div class="example-wrap">
                    ...
                    <div class="example">
                        <div class="btn-group hidden-xs" id="tableToolbar" role="group">
                            ...
                            <button type="button" class="btn  btn-danger redelete">
                                彻底删除
                            </button>
                        </div>
                        <table id="tablelist" data-url="<?php echo U('trash');?>" data-mobile-responsive="true" >
                            <thead>
                            <tr>
                                <th data-checkbox="true"></th>
                                <th data-field="id" data-sortable="true">ID</th>
                                <th data-field="title" data-sortable="true">标题</th>
                                <th data-field="cate_id" data-sortable="true">所属分类</th>
                                <th data-field="sort" data-sortable="true">排序</th>
                                <th data-field="id" data-formatter="$.trashact" >操作</th>
                            </tr>
                            </thead>
                        </table>
                    </div>

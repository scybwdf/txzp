...
<table border="0" cellpadding="0" cellspacing="0" class="tb_style">
  <form action="shanpay.php" method="post" name="shanpayment" target="_blank" id="shanpayment">
    <tr>
      <td width="210"   height="50"  class="td_border"><a href="http://www.passpay.net"><img src="images/logo.png" border="0"></a></td>
...
<table border="0" cellpadding="0" cellspacing="0" class="tb_style">
  <form name="shanpayment" action="shanpay.php" method="post" target="_blank">
    ...
    <tr>
      ...
      <td colspan="2"  class="td_border"><input name="WIDout_trade_no" type="text" value="PS<?php echo $a.$b;?> " size="35"  />        
    ...
    <tr>
      ...
      <td colspan="2"  class="td_border"><input name="WIDtotal_fee" type="text" value="10" size="35" />        <font color="#FF0000">* 必填</font> &nbsp;&nbsp;&nbsp;商品的交易金额</td>
    </tr>
    <tr>

...
class Html extends TagLib{
    ...
    protected $tags   =  array(
       ...
       // 'editor'    => array('attr'=>'id,name,content,width,height,type','close'=>1),
        ...
        'radio'     => array('attr'=>'name,radios,checked,separator','close'=>0),
		         'imgUpload' => array('attr'=>'id,name,width,height,value','close'=>1),
  ...
  public function _editor($tag) {
        ...
        $name   	=	$tag['name'];
        $style   	    =	 !empty($tag['style'])?$tag['style']:'width:75%;height:320px;';
    ...
    {
       // $tag        = $this->parseXmlAttr($tags,'imgUpload');
        $name       = $tag['name'];
        $id         = $tag['id'];
        ...
        if($value)
        {
            $img_url = "<if condition=\"".$value." eq ''\">".__ROOT__."/public/images/nophoto.gif<else />{".$value."}</if>";
            $svalue = "{".$value."}";
        }
        else
        {
            $img_url = __ROOT__.'/public/images/nophoto.gif';
            $svalue = "";
        }
        ...
        <div style='float:left; height:".$width."px; padding-top:1px;'>
         ...
         <div style='float:left; height:".$width."px; padding-top:1px;'>
             <div class='buttonActive'>
                <div class='buttonContent'>
                    <img src='".__ROOT__."/public/images/del.gif' style='$cls; margin-left:10px; float:left; border:#ccc solid 1px; width:35px; height:35px; cursor:pointer;' class='keimg_d' rel='$name' title='删除'>
                </div>
            </div>
        </div>
        </span>";
